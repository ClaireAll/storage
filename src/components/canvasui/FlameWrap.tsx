...
export interface FlameWrapOptions {
  /** Whether to capture wrapped HTML into the flame canvas. Disable for overlay-only fire. */
...
export function FlameWrap({
  ...
  const native = captureContent && supported && !failed;
  ...
  }, [captureContent, initialOptions, native]);
    ...
    <div className={className} style={{ position: "relative", ...style }}>
      ...
      {!native ? (
        <div
          ...
          style={{
            position: "relative",
            zIndex: captureContent ? undefined : 1,
            width: "100%",
            height: "100%",
            overflow: "auto",
          }}
      ...
      <canvas
        ...
        style={{
          ...
          pointerEvents: "none",
          zIndex: captureContent ? undefined : 2,
        }}
      />
    </div>
  );
